    ...
    <div className="section-container">
      <div className="section-box">
        ...
        <div className="section-box-text about-us-text md:w-[50%] mt-12">
          ...
          <button className="px-6 py-3 font-medium text-sm md:text-lg border border-blue-800 rounded-lg bg-blue-800 text-white hover:bg-blue-500 duration-300 hover:border-blue-600">
            Contact Us
          </button>
        </div>
      </div>
